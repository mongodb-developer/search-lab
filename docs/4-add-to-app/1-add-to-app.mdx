...
To use the aggregation pipeline in Java with Spring Data MongoDB, you can build your search stage using the $search operator and then create an Aggregation. Finally, run the aggregation with MongoTemplate.aggregate, mapping the results directly to your domain class.
