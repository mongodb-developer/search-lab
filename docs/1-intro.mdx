...
|Workshop goals|Learn how to use MongoDB Search and GraphQL to integrate powerful full-text search in your apps|
|-|-|
|What you'll learn|How to set up and take advantage of MongoDB Search|
