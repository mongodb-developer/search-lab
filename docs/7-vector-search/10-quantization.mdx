...
The MongoDB Search metrics however will show a much smaller index that is held in memory when you enable automatic quantization. Refer to our [documentation](https://www.mongodb.com/docs/atlas/atlas-vector-search/deployment-options/#storage-requirements-for-vectors) to learn more about these considerations.
