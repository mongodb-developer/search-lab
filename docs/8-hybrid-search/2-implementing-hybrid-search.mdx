...
1. Ensure you have [created an MongoDB Search index](https://mongodb-developer.github.io/search-lab/docs/search/search-index) on the **books** collection with **dynamic mappings**.
...
MongoDB Search and MongoDB Vector Search, by default, return documents sorted by their relevancy score from highest to lowest, i.e. they are ranked by default.
